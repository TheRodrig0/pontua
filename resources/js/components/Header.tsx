        ...
        <header className="sticky top-0 z-50 bg-app-bg dark:bg-app-darkbg border-b border-slate-200/80 dark:border-slate-800 shadow-xs">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-18 flex items-center justify-between">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <a
                                ...
                                className={`text-sm font-semibold whitespace-nowrap transition-colors ${isActive
                                    ? 'text-app-teal'
                ...
                <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                    ...
                    {/* Botão de Menu para Celular e Tablet */}
                    <button
                        type="button"
            ...
            {/* Menu Dropdown para Tablet e Mobile */}
            {isMobileMenuOpen && (
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <a
                                    ...
                                    href={item.href}
                                    onClick={() => handleNavClick(item.href)}
                                    className={`text-base font-semibold py-2 px-3 rounded-lg transition-colors ${isActive
