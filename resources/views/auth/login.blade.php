    ...
    <div class="lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-app border border-[#e2e8f0]/80">
            ...
            <div class="flex flex-col items-center text-center mb-7">
                ...
                <h2 class="font-poppins font-bold text-xl text-[#273142] mb-1.5 leading-snug">
            ...
            <form action="/dashboard" method="GET" class="space-y-4">
                ...
                <div class="text-center pt-2">
                    <span class="text-xs text-[#7a889b]">Ainda não participa do desafio?</span>
                </div>

                <!-- Create Account Button -->
                <div>
                    <a href="/register" class="w-full py-3 bg-[#f8fafc] hover:bg-slate-100 border border-[#e2e8f0] text-[#3b475c] font-poppins font-bold rounded-xl text-xs uppercase tracking-wider transition cursor-pointer text-center block">
                        CRIAR NOVA CONTA
                    </a>
                </div>
