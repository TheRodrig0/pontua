    ...
    <div class="lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md bg-white dark:bg-[#1e293b] rounded-3xl p-8 sm:p-10 shadow-app border border-[#e2e8f0]/80 dark:border-[#334155] transition-colors">
            ...
            <form action="/dashboard" method="GET" class="space-y-4">
                ...
                <div class="pt-1">
                    <a href="/login" class="w-full py-3 bg-[#f8fafc] dark:bg-[#111827] hover:bg-slate-100 dark:hover:bg-[#111827]/80 border border-[#e2e8f0] dark:border-[#334155] text-[#3b475c] dark:text-slate-200 font-poppins font-bold rounded-xl text-xs uppercase tracking-wider transition cursor-pointer text-center block">
                        JÁ TENHO UMA CONTA
                    </a>
                </div>
