...
<div class="min-h-screen w-full flex flex-col lg:flex-row bg-[#eff3f6]">
    ...
    <div class="lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-app border border-[#e2e8f0]/80">
            ...
            <p class="text-xs text-[#7a889b] leading-relaxed mb-5 text-center sm:text-left">
            ...
            <form action="/login" method="GET" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative flex items-center">
                        <input type="email" 
                               ...
                               required>
                        <div class="absolute right-3.5 text-slate-400 pointer-events-none p-1">
                ...
                <div class="pt-3 text-center">
                    <a href="/login" class="text-xs font-semibold text-[#7a889b] hover:text-[#4bb9a6] transition inline-flex items-center gap-1.5">
